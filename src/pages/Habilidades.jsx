...
const Habilidades = () => {
  ...
  const animation = (e) => {
    ...
    if(e._targetInst.type !== "div") {
      return
    }

    e.target.classList.add("descolgado")

    setTimeout( () => e.target.classList.remove("descolgado"), 2000)
  }
      ...
      <div className="fondo-gris-1 pb-32 lg:scroll-mt-20 scroll-mt-28" id='habilidades'>
        ...
        <div className="flex md:max-w-[80%] max-w-[95%] lg:max-w-[85%] m-auto text-gris-100 h-4/5 flex-col lg:flex-row'">
          ...
          <div className='sm:grid flex flex-col lg:grid-cols-5 gap-3 grid-cols-4 lg:grid-rows-2  grid-rows-3'>
            <div onMouseEnter={animation} className="habilidades w-full justify-center cursor-pointer fondo-blur mr-4 py-2 flex text-3xl font-semibold">
              <span className='flex justify-center items-center mr-2'>HTML</span>
              <img src={HTML} alt="Logo html" />
            </div>
            <div onMouseEnter={animation} className="w-full justify-center cursor-pointer fondo-blur mr-4 py-2 flex text-3xl font-semibold">
              <span className='flex justify-center items-center mr-2'>CSS</span>
              <img src={CSS} alt="Logo html" />
            </div>
            <div onMouseEnter={animation} className="w-full justify-center col-start-3 col-end-5 cursor-pointer fondo-blur mr-4 py-2 flex text-3xl font-semibold">
            ...
            <div onMouseEnter={animation} className="w-full justify-center cursor-pointer fondo-blur mr-4 py-2 flex text-3xl font-semibold lg:col-start-3 lg:col-end-5 row-start-2 row-end-3 col-start-3 col-end-5">
              <span className='flex justify-center items-center mr-2'>TAILWIND</span>
              <img src={TAILWIND} alt="Logo html" />
            </div>
            <div onMouseEnter={animation} className="w-full justify-center cursor-pointer fondo-blur mr-4 pl-6 pr-[28px] py-2 flex text-3xl font-semibold">
