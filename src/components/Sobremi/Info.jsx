    ...
    <div className="lg:w-4/6 w-5/6 mb-10">
      ...
      <div className="sm:text-2xl text-xl">
        ...
        <p>Todo lo que se lo he aprendindo online
          ya sea en youtube, udemy, o la documentación y algo que nunca olvidare en mi transcurso de aprendizaje es el lema de un canal de youtube programación ATS
          <span className="text-azul">“Si puedes imaginarlo, puedes pogramarlo”.</span>
        </p>
      </div>
    </div>
  );
